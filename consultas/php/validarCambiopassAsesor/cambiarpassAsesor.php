...
<div class="flex justify-center">
                ...
                <form class="space-y-4" action="validarasesor.php" method="POST">
               
                <div>
                        <label  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">correo</label>
                        <input type="email" name="usuario" value='<?php echo $correo; ?>' class="bg-gray-50 block border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Ingrese el codigo enviado a su correo" required />
                    </div>
                    <div>
